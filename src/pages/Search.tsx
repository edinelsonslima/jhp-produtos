...
export default function Search() {
  ...
  const filteredSales = q
    ? sales.filter((s) => {
        ...
        const productMatch = s.products.custom.some((p) =>
        ...
        const priceMatch = formatCurrency(s.price.total)
          .toLowerCase()
          .includes(q);
              ...
              <div key={emp.id} className="flex items-center gap-3 px-4 py-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-base-content/60">
                    Diárias: {formatCurrency(emp.defaultRates[0])} /{" "}
                    {formatCurrency(emp.defaultRates[1])}
                  </p>
                </div>
              </div>
            ))}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-base-content/60 font-mono">
                    ...
                    {product.unit === "litro" ? "litro" : "unidade"}
                  </p>
                </div>
              </div>
            ))}
